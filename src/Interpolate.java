...
public class Interpolate {
    public static void SolveInterpolate(){
        ...
        for(int i = n-1; i >= 0; i--){
            ...
            else System.out.printf("%fx^%d + ", a[i], i);
        }
        ...
        if(choice == 1){
            ...
            try{
                ...
                for(int i= n-1;i >= 0; i--){
                    if(i == 0) file.write(Double.toString(a[i])+",\n");
                    else file.write(Double.toString(a[i])+"x^"+Integer.toString(i)+" + ");
                }
